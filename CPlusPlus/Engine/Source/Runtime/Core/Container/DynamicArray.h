...
#pragma region Details
	...
	template<typename T, typename Allocator>
	const typename DynamicArray<T, Allocator>::ConstIterator DynamicArray<T, Allocator>::begin() const
	{
		return GetBuffer();
	}

	template<typename T, typename Allocator>
	const typename DynamicArray<T, Allocator>::ConstIterator DynamicArray<T, Allocator>::end() const
	{
		return GetBuffer() + count;
	}
