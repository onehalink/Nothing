...
namespace Engine
{
	...
	*/
	...
	template<typename EnumClass> constexpr typename EnableIf<EnableBitwiseOperators<EnumClass>::Value, Bool>::Type HasAnyFlags(EnumClass E, EnumClass flags);
	template<typename EnumClass> constexpr typename EnableIf<EnableBitwiseOperators<EnumClass>::Value, Bool>::Type HasAllFlags(EnumClass E, EnumClass flags);
...
#pragma region Details
	...
	template<typename EnumClass>
	constexpr typename EnableIf<EnableBitwiseOperators<EnumClass>::Value, Bool>::Type HasAnyFlags(EnumClass E, EnumClass flags)
	{
		return ( E & flags ) != EnumClass();
	}

	template<typename EnumClass>
	constexpr typename EnableIf<EnableBitwiseOperators<EnumClass>::Value, Bool>::Type HasAllFlags(EnumClass E, EnumClass flags)
	{
