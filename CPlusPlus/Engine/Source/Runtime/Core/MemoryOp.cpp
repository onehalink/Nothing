...
namespace Engine
{
	...
	Void MemoryOp::Clear(Void* buffer, SizeType byteCount)
	{
	...
	Void MemoryOp::Copy(const Void* from, Void* to, SizeType byteCount)
	{
		SizeType count	= byteCount / AlignSize;
		SizeType modulo = byteCount % AlignSize;
		SizeType offset = byteCount - modulo;
	...
	Bool MemoryOp::Equal(const Void* bufferA, const Void* bufferB, SizeType byteCount)
	{
		SizeType count	= byteCount / AlignSize;
		SizeType modulo	= byteCount % AlignSize;
		SizeType offset	= byteCount - modulo;
