...
namespace Engine
{
	...
	struct Matrix : Private::MatrixBase<D, T>, Private::MatrixConstants<D, T, Matrix<D, T>>
	{
...
#pragma region Details
	...
	template<Dimension D, typename T>
	Matrix<D, T> operator*(const Matrix<D, T>& matrix, T scalar)
	{
		Matrix<D, T> ret;
	...
	template<Dimension D, typename T>
	Matrix<D, T> operator*(T scalar, const Matrix<D, T>& matrix)
	{
